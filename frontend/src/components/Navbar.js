  ...
  return (
    <div className="header">
      <div className="flex items-center">
        ...
        <div className="links flex list-none gap-10 px-10 ">
          <li >
      ...
      <div >
        <a className="navbar-logo hover:scale-125 " href="/">
      ...
      <div>
        <div className=" flex gap-3 items-center">
          <a className="navbar-profile  hover:scale-125" href="/login">
            <img src={Profile} alt="profile" width="40" height="40" />
          </a>
          <p>Items: 0</p>
          <a className="navbar-cart  hover:scale-125" href="/cart">
            <img src={Cart} alt="cart" width="40" height="40" />
          </a>
        </div>
        <div className="navbar-search  hover:scale-105">
          <button>
